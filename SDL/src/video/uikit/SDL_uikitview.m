...
-(IBAction) procKeyInfo:(id) notify{
    ...
    if (v == 4){
        ...
        SDL_SendKeyboardKey(SDL_PRESSED, SDL_SCANCODE_H);
        SDL_SendKeyboardKey(SDL_RELEASED,SDL_SCANCODE_H);
    }
    else if (v == 1){
        SDL_SendKeyboardKey(SDL_PRESSED, SDL_SCANCODE_L);
        SDL_SendKeyboardKey(SDL_RELEASED,SDL_SCANCODE_L);
    }
    else if (v == 0){
