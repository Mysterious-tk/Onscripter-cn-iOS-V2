...
UIViewController* myRootController;
...
*/
  ...
  //  [[NSFileManager defaultManager] changeCurrentDirectoryPath: [[NSBundle mainBundle] resourcePath]];
    ...
    ONS_selectview *viewController1;
    ONS_choiceview *viewController2;
    self.window = [[UIWindow alloc]initWithFrame:[[UIScreen mainScreen]bounds]];
    //viewController1 = [[ONS_selectview alloc]initWithStyle:UITableViewStylePlain];
    viewController1 = [[ONS_selectview alloc]initWithNibName:@"ONS_selectview" bundle:nil];
    
    // viewController2 = [[ONS_choiceview alloc]initWithStyle:UITableViewStyleGrouped];
    viewController2 = [[ONS_choiceview alloc]initWithNibName:@"ONS_choiceview" bundle:nil];
    
    self.tabBarController = [[[UITabBarController alloc]init] autorelease];
    self.tabBarController.viewControllers = [NSArray arrayWithObjects:viewController1,viewController2, nil];
    
    self.window.rootViewController = self.tabBarController;
    myRootController = self.window.rootViewController;
