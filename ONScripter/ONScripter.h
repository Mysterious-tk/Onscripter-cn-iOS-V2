...
private:
    ...
    void runEventLoop();
	void AutoSavegame();
	static Uint32 SDLCALL saveCallback( Uint32 interval, void *param );
	static Uint32 SDLCALL loopbgmCallback( Uint32 interval, void *param );
