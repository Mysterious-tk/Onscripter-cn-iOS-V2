...
public:
    ...
    void scalePosXY(int screen_ratio1, int screen_ratio2){
		...
		{
			pos.x = orig_pos.x * (screen_ratio1 + 95) / screen_ratio2;
		}
		else if(screen_ratio1 == 256 || screen_ratio1 == 320)
		{
			pos.x = orig_pos.x * (screen_ratio1 + 32) / screen_ratio2;
		}
		else if( screen_ratio1 == 384 || screen_ratio1 == 481 || screen_ratio1 == 1024 || screen_ratio1 == 1280 )
		{
			pos.x = orig_pos.x * (screen_ratio1 + 130) / screen_ratio2;
		}
		else if(screen_ratio1 == 865 || screen_ratio1 == 1081 || screen_ratio1 == 1025 || screen_ratio1 == 1281 )
		{
			pos.x = orig_pos.x * (screen_ratio1 + 285) / screen_ratio2;
		}
		else if(screen_ratio1 == 1537 || screen_ratio1 == 1921 )
		{
			pos.x = orig_pos.x * (screen_ratio1 + 520) / screen_ratio2;
		}
		else
