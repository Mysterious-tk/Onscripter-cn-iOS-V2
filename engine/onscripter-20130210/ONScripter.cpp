...
//#if defined(ANDROID)
	...
	sprintf(wide,"%s%s",archive_path,"ons.wide");
...
#if defined(ANDROID)
FILE *fp;   
    char debug[50]="/sdcard/ons/onsdebug.ini";
...
void ONScripter::setScaleScreenMode()
{
	scale_screen_mode = true;
}
